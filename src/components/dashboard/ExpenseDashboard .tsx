  ...
  return (
    <div className={cn("dashboard-page-bg min-h-screen", className)}>
      ...
      <div className="relative z-10">
        {/* Retro Header */}
        <header className="accounting-header px-6 py-4 sticky top-0 z-20">
            ...
            <div className="space-y-3">
              ...
              {calculatedMetrics.insights.map((insight, index) => (
                <Alert
                  ...
                  className={cn(
                    "calculator-printout border-l-4",
        ...
        {/* Footer */}
        <footer className="mt-16 border-t-2 border-rubber-stamp bg-paper-aged">
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              ...
              <div className="text-center">
                ...
                <div className="inline-block mt-2 px-3 py-1 border typewriter-text text-xs transform rotate-1">
